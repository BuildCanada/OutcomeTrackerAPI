class CommitmentExtractor < Chat
  ...
  def prompt(chunk, existing_commitments, policy_areas, departments)
    ...
    STRUCTURING RULES:
    1. ONE verifiable thing per commitment. Break compound promises into separate commitments.
    ...
    4. Do NOT create parent/umbrella commitments. Each commitment must be independently verifiable.
    ...
    - aspirational: Broad directional goals without specific metrics
